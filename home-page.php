...
<section class="container-fluid about-bg text-center">
    ...
    <section class="container-fluid articles-bg">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <img class="img-fluid" src="http://170.187.231.66/~mesh14/wp-content/themes/starter_for_josh_site/images/article_image_1.jpg" alt="Illustration of a woman in an action pose holding a bow.">
